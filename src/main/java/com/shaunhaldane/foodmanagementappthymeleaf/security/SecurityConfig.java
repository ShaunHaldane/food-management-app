package com.shaunhaldane.foodmanagementappthymeleaf.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			.antMatchers("/", "/login")
				.permitAll()
			.antMatchers("/deleteUser", "/getAllFoodItems", "/getAllWastedFoodItems")
				.hasAnyRole("ADMIN")
			.antMatchers("/addFoodItem", "/editFoodItem", "/moneySpentGraphs")
				.hasAnyRole("CLIENT")
			.and()
				.formLogin()
				.loginPage("/login")
